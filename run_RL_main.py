...
def create_sub_agent(args, env, actor_name, agentcls, hyparams):
    hyparams.memory_size = 500000
    hyparams.init_episode = 200000
    hyparams.memory_path = os.path.join("baselines/RMTL", "pretrain/memory.pkl")
    hyparams.pretrain_path = os.path.join("saved_models", args.env, actor_name)
...
if __name__ == '__main__':
    ...
    # 2. Agent design
    agent = create_sub_agent(env, 'esmm', TD3_ESMMBCAgent, hyparams)  # TD3BC agent, 0 as ac loss by default
