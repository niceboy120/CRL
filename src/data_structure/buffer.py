...
class ReplayBuffer:
    ...
    _reserved_keys = (
        "x_batch", "seq_batch", "y_batch", "len_data_batch"
    )
    _input_keys = (
        "x_batch", "seq_batch", "y_batch", "len_data_batch"
    )
    ...
    def __getitem__(self, index: Union[slice, int, List[int], np.ndarray]) -> Batch:
        ...
        x_batch = self.get(indices, "x_batch")
        batch_dict = {
            "x_batch": x_batch,
            "seq_batch": self.seq_batch[indices],
            "y_batch": self.y_batch[indices],
            "len_data_batch": self.len_data_batch[indices],
        }
