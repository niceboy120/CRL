...
class Arguments:
    def __init__(self, *args):
        ...
        # path related
        self.test_path = os.path.join("baselines/RMTL", "dataset/rt/test.csv")
        self.val_path = os.path.join("baselines/RMTL", "dataset/rt/val.csv")
        self.train_path = os.path.join("baselines/RMTL", "dataset/rt/train.csv")
        self.features_path = os.path.join("baselines/RMTL", "dataset/rt/item_feadf.csv")
        self.map_path = os.path.join("baselines/RMTL", "pretrain")
        self.pretrain_path = os.path.join("baselines/RMTL", "pretrain/")
        self.memory_path = os.path.join("baselines/RMTL", "pretrain/memory.pkl")
